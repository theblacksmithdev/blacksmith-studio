...
import { MoreVertical, Eye, BotMessageSquare, Trash2, PackageOpen } from 'lucide-react'
...
export function ServiceMenu({ hasSetupCommand, onSetup, onViewDetails, onDiagnose, onDelete }: ServiceMenuProps) {
  const options: MenuOption[] = useMemo(() => [
    ...(hasSetupCommand ? [{ icon: <PackageOpen />, label: 'Run Setup', onClick: onSetup }] : []),
