...
export const BackBtn = styled.button`
  ...
  flex-shrink: 0;
  &:hover { border-color: var(--studio-border-hover); color: var(--studio-text-primary); background: var(--studio-bg-hover); }
`
...
export const StatPill = styled.div`
  ...
  font-weight: 500;
  color: var(--studio-text-muted);
  span { font-variant-numeric: tabular-nums; color: var(--studio-text-secondary); }
`
...
export const AgentBubble = styled.div`
  ...
  overflow: hidden;
  .markdown-body { font-size: 13.5px; line-height: 1.6; > *:first-child { margin-top: 0; } > *:last-child { margin-bottom: 0; } p { margin-bottom: 6px; } pre { margin: 8px 0; } }
`
...
export const ThinkingBubble = styled.div`
  ...
  font-style: italic;
  overflow: hidden;
  .markdown-body { font-size: 13px; line-height: 1.6; color: var(--studio-text-secondary); > *:first-child { margin-top: 0; } > *:last-child { margin-bottom: 0; } p { margin-bottom: 6px; } }
`
...
export const SystemBubble = styled.div<{ $error?: boolean }>`
  ...
  border: 1px solid ${({ $error }) => $error ? 'var(--studio-error)' : 'var(--studio-border)'};
...
export const ToolCodeWrap = styled.div`
  ...
  .markdown-body { font-size: 13px; line-height: 1.5; > *:first-child { margin-top: 0; } > *:last-child { margin-bottom: 0; } pre { margin: 0; } }
`
