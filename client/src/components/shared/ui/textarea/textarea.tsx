...
const sizeStyles: Record<TextareaSize, SystemStyleObject> = {
  sm: { padding: `${spacing.xs} ${spacing.sm}`, fontSize: '12px', borderRadius: radii.md, minHeight: '60px' },
  md: { padding: `${spacing.sm} ${spacing.md}`, fontSize: '13px', borderRadius: radii.md, minHeight: '80px' },
}
