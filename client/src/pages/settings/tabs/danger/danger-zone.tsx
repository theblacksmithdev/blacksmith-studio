...
const DangerBtn = styled.button<{ fill?: boolean }>`
  ...
  &:hover {
    ${(p) =>
      p.fill ? "opacity: 0.9;" : "background: var(--studio-error-subtle);"}
  }
`;
        ...
        <DangerCard>
          <DangerRow>
            <Box css={{ flex: 1 }}>
              ...
              >
                Unlink this project. Files on disk stay untouched, but chat
                history and settings are deleted.
              </Text>
            </Box>
          ...
          <DangerRow>
            <Box css={{ flex: 1 }}>
              ...
              >
                Permanently delete the project folder from disk and remove all
                data from Studio.
              </Text>
            </Box>
            <DangerBtn fill onClick={() => setModalMode("hard")}>
              Delete everything
            </DangerBtn>
          </DangerRow>
        </DangerCard>
                ...
                >
                  {modalMode === "hard" ? (
                    <>
                      ...
                      from disk, along with all chat history and settings.
                    </>
                  ) : (
