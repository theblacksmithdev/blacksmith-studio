...
export function McpEmptyState({ browsePath }: McpEmptyStateProps) {
  return (
    <Wrap>
      <IconWrap>
        <Blocks size={24} />
      ...
      <Flex direction="column" gap="6px" align="center">
        ...
        >
          Connect external tools, databases, and APIs through the Model Context
          Protocol. Give Claude the ability to read files, query databases, call
          APIs, and more.
        </Text>
      </Flex>
      <Flex direction="column" align="center" gap="10px">
        <PrimaryBtn to={browsePath}>
