...
export function SettingsSection({ title, description, children, badge, onReset }: SettingsSectionProps) {
  return (
    <Box>
      <Flex justify="space-between" align="flex-start" css={{ marginBottom: '14px' }}>
        <Box css={{ flex: 1 }}>
