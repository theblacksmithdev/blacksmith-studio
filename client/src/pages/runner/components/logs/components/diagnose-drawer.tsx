...
export function DiagnoseDrawer({ sessionId, initialPrompt, title, onClose }: DiagnoseDrawerProps) {
  ...
  return (
    <Drawer
      ...
      placement="end"
    >
      <Flex direction="column" css={{ height: '100%', margin: '-20px', marginTop: '-8px' }}>
        <MessageList
          messages={messages}
