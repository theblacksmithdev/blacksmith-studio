...
export function ServiceListHeader({ hasServices, anyActive, onAdd, onStartAll, onStopAll }: ServiceListHeaderProps) {
  return (
    <Flex align="center" justify="space-between" css={{ padding: `${spacing.sm} ${spacing.md}`, flexShrink: 0 }}>
      ...
      <Flex align="center" gap={spacing.xs}>
        <Tooltip content="Add service">
          <IconButton variant="ghost" size="sm" onClick={onAdd} aria-label="Add service">
            <Plus />
          </IconButton>
        </Tooltip>
        {hasServices && (
