...
import { Text, Badge, Skeleton, ConfirmDialog, spacing, radii } from '@/components/shared/ui'
      ...
      <Flex direction="column" gap="2px" css={{ flex: 1, overflowY: 'auto', padding: `0 ${spacing.xs} ${spacing.sm}` }}>
        ...
        <Flex
          ...
          css={{
            ...
            border: 'none',
            background: activeId === null ? 'var(--studio-bg-hover)' : 'transparent',
            cursor: 'pointer',
            fontFamily: 'inherit',
            textAlign: 'left',
            width: '100%',
        ...
        >
          <Text variant="bodySmall" css={{ fontWeight: activeId === null ? 500 : 400, flex: 1 }}>
            All Logs
          </Text>
